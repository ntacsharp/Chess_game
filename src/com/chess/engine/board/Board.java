...
public class Board {
    ...
    public static Board createStandardBoard() {
        ...
        builder.setPiece(new King(7, 4, Party.WHITE));
        builder.setPiece(new Bishop(7, 5, Party.WHITE));
        builder.setPiece(new Knight(7, 6, Party.WHITE));
        builder.setPiece(new Rook(7, 7, Party.WHITE));
        // BLACK
